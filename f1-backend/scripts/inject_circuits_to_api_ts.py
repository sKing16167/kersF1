...
with open(r'C:\KERS\f1-backend\scripts\circuits_data.json', 'r', encoding='utf-8') as f:
...
if start_idx != -1 and end_idx != -1:
    ...
    print(f"Successfully replaced MOCK_CIRCUITS in lib/api.ts with {len(circuits)} circuits!")
else:
